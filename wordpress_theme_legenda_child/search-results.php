				...
				<?php if(have_posts()): ?>
					<?php while(have_posts()) : the_post(); ?>
						...
						<?php 
							...
							$args['count']      = 3;
							$args['images']     = 1;
							$args['products']   = (! empty( etheme_get_option('search_products') ) );
							$args['posts']      = (! empty( etheme_get_option('search_posts') ) );
							$args['portfolio']  = (! empty( etheme_get_option('search_projects') ) );
							$args['pages']      = (! empty( etheme_get_option('search_pages') ) );
							$args['format']     = 'array';
